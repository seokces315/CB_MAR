...
cardio_index = load_single_file("docs_cardio.txt")
# thorax_index = load_data("docs_covid")
...
def generate_report(class_mapping, predicted_class, concepts, contribution):
    ...
    metadata = ToolMetadata(
        name="RAG Tool CrewAI", description="Use this tool to lookup the information"
    )

    query_engine_tool = QueryEngineTool(
        query_engine=query_engine_crew, metadata=metadata
    )
